...
export const uiStrings = {
  en: {
    ...
    lineQuestionHint: 'Write the full code line for this operation:',
    lineAnswerPlaceholder: 'e.g. G81 X10 Y5 Z-12 R2 F100',
    ...
    lineResultIncorrect: (line: string) =>
      `Incorrect. The correct line is ${line}.`,
  ...
  ru: {
    ...
    lineQuestionHint: 'Напишите полную строку кода для этой операции:',
    lineAnswerPlaceholder: 'например, G81 X10 Y5 Z-12 R2 F100',
    submitTypedAnswer: 'Проверить',
    typedResultCorrect: 'Правильно!',
    typedResultIncorrect: (code: string) =>
      `Неправильно. Правильный код: ${code}.`,
    lineResultIncorrect: (line: string) =>
      `Неправильно. Правильная строка: ${line}.`,

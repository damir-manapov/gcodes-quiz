...
export const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: ['Linear interpolation at feed rate', 'Rapid positioning move', 'Dwell', 'Tool change'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Rapid traverse', 'Linear interpolation at feed rate', 'Spindle stop', 'Coolant off'],
    correctAnswer: 1,
    explanation: 'G01 moves the tool in a straight line at the programmed feed rate.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'G21 switches the machine to metric units, meaning millimeters.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation: 'CNC programs commonly use absolute coordinates unless otherwise specified.',
  },
  {
    id: 6,
    prompt: 'What does M03 command do?',
    options: ['Turn spindle clockwise', 'Turn spindle counterclockwise', 'Start coolant', 'End program'],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: ['Defines tool geometry', 'Defines machine movement behavior', 'Stores part numbers', 'Sets program language'],
    correctAnswer: 1,
    explanation: 'G codes control the machine motion and behavior during a program.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation: 'M30 is commonly used to end the program and rewind the tape or reset.',
  },
];

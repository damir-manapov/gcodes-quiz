...
// A question as authored in the bank. All wording variants of a concept are
// stored together in one array (no separate "base" + "variants" fields), so
// there's exactly one place that holds "the ways to phrase X":
// - `prompts`: every phrasing of the question itself.
// - `correctAnswers`: every phrasing of the correct answer.
// - `distractors`: the wrong-answer choices (no correct answer mixed in).
// A session picks one entry from each array; which one ends up "correct" for
// a multiple-choice list is computed at session-build time rather than
// stored, so it can never drift out of sync with the option list.
...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswers: [
      ...
      { en: 'The XY plane', ru: 'Плоскость XY' },
    ],
    explanation: {
  ...
  },
  {
    ...
    correctAnswers: [
      { en: 'ZX plane', ru: 'Плоскость ZX' },
      { en: 'The ZX plane', ru: 'Плоскость ZX' },
    ],
    explanation: {
  ...
  },
  {
    ...
    correctAnswers: [
      { en: 'YZ plane', ru: 'Плоскость YZ' },
      { en: 'The YZ plane', ru: 'Плоскость YZ' },
    ],
    explanation: {
